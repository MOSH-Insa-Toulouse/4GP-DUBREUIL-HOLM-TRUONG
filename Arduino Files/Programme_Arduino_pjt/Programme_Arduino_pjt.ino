...
#define PinServo 12 // Pin de commande servomoteur
...
#define PinCapteur A0 // Pin Capteur Graphene
...
"""Servo-moteur Mod"""
myServo.attach(PinServo); // Pin connectée pour le servo-moteur
}
void measure(){
  """Fonction qui fait la lecture analogique de la tension produite par le capteur graphene"""
...
"""Servo Mod
Les deux premières boucle for font le calcul pour le capteur graphene
"""
